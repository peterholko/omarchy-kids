...
conf_init() {
  "$OMARCHY_PATH/bin/omarchy-parent-files" config "$PARENT_CONF" init
}
...
conf_set() {
  "$OMARCHY_PATH/bin/omarchy-parent-files" config "$PARENT_CONF" set "$@"
}
...
conf_document() {
  "$OMARCHY_PATH/bin/omarchy-parent-files" config "$PARENT_CONF" document "$@"
}
