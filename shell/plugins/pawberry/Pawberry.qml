...
Item {
  ...
  PracticeBridge { id: practiceBridge }
  ...
  FloatingWindow {
    ...
    onClosed: root.close()
    HotelView { id: game; policy: practiceBridge; anchors.fill: parent; windowActive: Window.active && root.opened && root.schoolAllowed; onQuitRequested: root.close() }
  }
}
