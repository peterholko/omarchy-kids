...
trap 'sudo -K' EXIT
for package in base settings core dns browsing time school grove; do
...
for plugin in omarchy.screen-time omarchy.school-mode omarchy.math omarchy.number-grove; do
