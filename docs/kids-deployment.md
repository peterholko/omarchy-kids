...
Omarchy Kids supports converting a clean Omarchy 4 laptop and installing a fresh laptop from the dedicated Kids ISO. Both use the same ten package archives and `omarchy-kids-setup` to configure the account. Upstream PR acceptance is not a prerequisite.
